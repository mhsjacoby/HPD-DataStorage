...
class SubsetImages():
    ...
    def sample_imgs(self, df, sample_size=100):
        times = df.index
...
if __name__ == '__main__':
    ...
    parser.add_argument('-labels','--labels', default='', type=str, help='path of zone labels') # Stop at house level, example G:\H6-black\
    parser.add_argument('-drive','--drive', default='', type=str, help='path of stored images') # Stop at house level, example G:\H6-black\    
    ...
    for hub in hubs:
        ...
        for occ, i in zip(['occupied', 'vacant'], [1,0]):
